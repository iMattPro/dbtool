...
$lang = array_merge($lang, array(
	...
	'CLI_DBTOOL_EXPLAIN'	=> 'Vérifie, optimise et répare les tables de la base de données.',
	'CLI_DBTOOL_ARG_TABLE'	=> '[Optionnel] Il est possible d’indiquer une seule table via son nom pour effectuer la tâche uniquement sur celle-ci.',
	'CLI_DBTOOL_CONTINUE'	=> 'Confirmer l’action.',
	'CLI_DBTOOL_OPERATION'	=> 'Sélectionner une action à effectuer',
	'CLI_DBTOOL_RESULTS'	=> '%s résultats',
	'CLI_DBTOOL_LOCK_ERROR'	=> 'L’action n’a pu être effectuée car un autre processus a initié une autre action qui est toujours en cours sur la base de données. Merci d’essayer à nouveau dans une heure.',
));
