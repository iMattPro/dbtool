...
$lang = array_merge($lang, array(
	...
	'CLI_DBTOOL_EXPLAIN'	=> 'Veritabanı tablolarını kontrol edin, optimize edin ve onarın.',
	'CLI_DBTOOL_ARG_TABLE'	=> '[İsteğe bağlı] İşlemin uygulanacağı tek bir tabloyu adıyla belirtebilirsiniz.',
	'CLI_DBTOOL_CONTINUE'	=> 'Devam etmek istiyor musunuz?',
	'CLI_DBTOOL_OPERATION'	=> 'Gerçekleştirilecek işlemi seçin',
	'CLI_DBTOOL_RESULTS'	=> '%s sonuçları',
	'CLI_DBTOOL_LOCK_ERROR'	=> 'Başka bir işlem veritabanı üzerinde çalıştığı için bu işlem gerçekleştirilemedi. Bir saat sonra tekrar deneyin.',
));
