...
$lang = array_merge($lang, array(
	...
	'WARNING'			=> 'Ostrzeżenie',
	'WARNING_EXPLAIN'	=> 'Narzędzie to jest BEZ GWARANCJI i użytkownicy tego narzędzia, w przypadku awarii, powinni wykonać kopię zapasową całej bazy danych.<br><br>Przed kontynuowaniem upewnij się, że masz kopię zapasową bazy danych!',
	...
	'CLI_DBTOOL_EXPLAIN'	=> 'Sprawdź, zoptymalizuj i napraw tabele bazy danych.',
	'CLI_DBTOOL_ARG_TABLE'	=> '[Opcjonalnie] Możesz podać nazwę jednej tabeli, na której zostanie wykonana operacja.',
	'CLI_DBTOOL_CONTINUE'	=> 'Czy chcesz kontynuować?',
	'CLI_DBTOOL_OPERATION'	=> 'Wybierz operację do wykonania',
	'CLI_DBTOOL_RESULTS'	=> 'Wyniki operacji %s',
	'CLI_DBTOOL_LOCK_ERROR'	=> 'Nie można wykonać operacji, ponieważ inny proces wykonuje już operację na bazie danych. Spróbuj ponownie za godzinę.',
));
