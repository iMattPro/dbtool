...
$lang = array_merge($lang, array(
	...
	'CLI_DBTOOL_EXPLAIN'	=> 'Проверка, оптимизация и восстановление таблиц базы данных.',
	'CLI_DBTOOL_ARG_TABLE'	=> '[Необязательно] Вы можете указать имя одной таблицы, над которой будет выполнена операция.',
	'CLI_DBTOOL_CONTINUE'	=> 'Продолжить?',
	'CLI_DBTOOL_OPERATION'	=> 'Выберите операцию для выполнения',
	'CLI_DBTOOL_RESULTS'	=> 'Результаты: %s',
	'CLI_DBTOOL_LOCK_ERROR'	=> 'Операцию выполнить не удалось: другой процесс уже выполняет операцию с базой данных. Повторите попытку через час.',
));
