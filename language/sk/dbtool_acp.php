...
$lang = array_merge($lang, array(
	...
	'CLI_DBTOOL_EXPLAIN'	=> 'Skontrolovať, optimalizovať a opraviť databázové tabuľky.',
	'CLI_DBTOOL_ARG_TABLE'	=> '[Voliteľné] Môžete zadať názov jednej tabuľky, na ktorej sa operácia vykoná.',
	'CLI_DBTOOL_CONTINUE'	=> 'Chcete pokračovať?',
	'CLI_DBTOOL_OPERATION'	=> 'Vyberte operáciu, ktorá sa má vykonať',
	'CLI_DBTOOL_RESULTS'	=> 'Výsledky operácie %s',
	'CLI_DBTOOL_LOCK_ERROR'	=> 'Operáciu nemožno vykonať, pretože iný proces už vykonáva databázovú operáciu. Skúste to znova o hodinu.',
));
