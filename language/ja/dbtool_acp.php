...
$lang = array_merge($lang, array(
	...
	'CLI_DBTOOL_EXPLAIN'	=> 'データベーステーブルをチェック、最適化、修復します。',
	'CLI_DBTOOL_ARG_TABLE'	=> '[任意] 操作を実行するテーブルを名前で1つ指定できます。',
	'CLI_DBTOOL_CONTINUE'	=> '続行しますか？',
	'CLI_DBTOOL_OPERATION'	=> '実行する操作を選択してください',
	'CLI_DBTOOL_RESULTS'	=> '%s の結果',
	'CLI_DBTOOL_LOCK_ERROR'	=> '別のプロセスがデータベース操作を実行中のため、操作を実行できませんでした。1時間後にもう一度お試しください。',
));
