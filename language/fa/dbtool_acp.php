...
$lang = array_merge($lang, array(
	...
	'CLI_DBTOOL_EXPLAIN'	=> 'بررسی، بهینه‌سازی و تعمیر جدول‌های پایگاه داده.',
	'CLI_DBTOOL_ARG_TABLE'	=> '[اختیاری] می‌توانید نام یک جدول را برای انجام عملیات روی آن مشخص کنید.',
	'CLI_DBTOOL_CONTINUE'	=> 'آیا می‌خواهید ادامه دهید؟',
	'CLI_DBTOOL_OPERATION'	=> 'عملیات مورد نظر را انتخاب کنید',
	'CLI_DBTOOL_RESULTS'	=> 'نتایج %s',
	'CLI_DBTOOL_LOCK_ERROR'	=> 'عملیات قابل انجام نیست، زیرا فرایند دیگری در حال اجرای عملیات پایگاه داده است. یک ساعت دیگر دوباره تلاش کنید.',
));
