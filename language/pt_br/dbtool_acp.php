...
$lang = array_merge($lang, array(
	...
	'CLI_DBTOOL_EXPLAIN'	=> 'Verifique, otimize e repare as tabelas do banco de dados.',
	'CLI_DBTOOL_ARG_TABLE'	=> '[Opcional] Você pode especificar uma única tabela pelo nome para executar a operação.',
	'CLI_DBTOOL_CONTINUE'	=> 'Deseja continuar?',
	'CLI_DBTOOL_OPERATION'	=> 'Escolha uma operação para executar',
	'CLI_DBTOOL_RESULTS'	=> 'Resultados de %s',
	'CLI_DBTOOL_LOCK_ERROR'	=> 'A operação não pôde ser executada porque outro processo já está realizando uma operação no banco de dados. Tente novamente em uma hora.',
));
